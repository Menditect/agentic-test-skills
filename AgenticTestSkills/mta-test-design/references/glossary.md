...
| **`EditAssertMicroflowReturnValueCompare`** | `ComparisonOperator` | **Plural**: `"Equals"`, `"NotEquals"`, `"GreaterThan"`, `"GreaterThanOrEqual"`, `"LessThan"`, `"LessThanOrEqual"`, `"Contains"`, `"NotContains"`, `"StartsWith"`, `"EndsWith"`<br>*(MANDATORY: Must pass `ComparisonOperator` alongside value setters like `SetDecimalValue`)* |
...
| **`EditAttributeValueFilter`** | `FilterComparisonOperator` | **Plural**: `"Equals"`, `"NotEquals"`, `"GreaterThan"`, `"GreaterThanOrEqual"`, `"LessThan"`, `"LessThanOrEqual"`, `"Contains"`, `"NotContains"`, `"StartsWith"`, `"EndsWith"` |
