...
### 📝 Release Message
new version of skills, optimized for last MTA update
...
| **mta-build** | `3.2_2.8` | new version of skills, optimized for last MTA update |
| **mta-install-config** | `1.1.3` | added platform-agnostic cross-skill redirection rules for vague or onboarding requests |
| **mta-run-analyze** | `3.2_2.3` | new version of skills, optimized for last MTA update |
...
- **Key Changes:** new version of skills, optimized for last MTA update
