...
### 📝 Release Message
improved handling of associations in datavariations
...
| :--- | :--- | :--- |
| **AGENTS.md (Orchestrator)** | `4.26.0` | Added PAT-07 invariant and prohibited association rows in Data Variation Matrices. |
...
| **mta-test-design** | `6.23.0` | Enforced PAT-07 Empty Object pattern and prohibited association variation rows in Data Variation Matrices. |

---

### 🛠️ Individual Skill Details

#### 🔹 AGENTS.md (Orchestrator) (`v4.26.0`)
...
- **Key Changes:** Added PAT-07 invariant and prohibited association rows in Data Variation Matrices.
...
- **Key Changes:** Enforced PAT-07 Empty Object pattern and prohibited association variation rows in Data Variation Matrices.
