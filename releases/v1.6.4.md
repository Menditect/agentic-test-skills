...
### 📝 Release Message
better separation of frontend and backend test creation
...
| **mta-build** | `3.2_2.5` | enforce strict category validation and anti-mixing rules in state model |
| **mta-install-config** | `1.1.2` | updated skills with input from MTA 3.1 reference guide |
| **mta-run-analyze** | `3.2_2.0` | enforce strict category validation and anti-mixing rules in state model |
...
- **Key Changes:** enforce strict category validation and anti-mixing rules in state model
