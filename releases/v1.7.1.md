...
### 📝 Release Message
updated skills for datavariation strategy
...
| **mta-build** | `3.2_2.9` | added mutual exclusivity of test suite and test case variations |
| **mta-install-config** | `1.1.3` | added platform-agnostic cross-skill redirection rules for vague or onboarding requests |
| **mta-run-analyze** | `3.2_2.4` | added mutual exclusivity of test suite and test case variations |
...
- **Key Changes:** added mutual exclusivity of test suite and test case variations
