...
### 📝 Release Message
enforce strict Category A and B separation in mta-build skill
...
| **mta-build** | `3.2_1.3` | Enforce strict Category A (Backend) vs Category B (Frontend) reference loading and testing boundary isolation. |
| **mta-run-analyze** | `3.2_1.2` | updatede license file with notice |
| **mta-test-design** | `3.2_1.4` | updatede license file with notice |
...
- **Key Changes:** Enforce strict Category A (Backend) vs Category B (Frontend) reference loading and testing boundary isolation.
