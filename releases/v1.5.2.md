...
### 📝 Release Message
clarified execution settings rule for backend tests
...
| **mta-build** | `3.2_1.6` | clarified execution settings rule for backend tests |
...
- **Key Changes:** clarified execution settings rule for backend tests
