...
### 📝 Release Message
release: v1.6.2 - updated skills with input from MTA 3.1 reference guide
...
| **mta-build** | `3.2_2.3` | updated skills with input from MTA 3.1 reference guide |
| **mta-install-config** | `1.1.2` | updated skills with input from MTA 3.1 reference guide |
| **mta-run-analyze** | `3.2_1.8` | updated skills with input from MTA 3.1 reference guide |
