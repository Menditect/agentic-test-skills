...
### 📝 Release Message
added more required fiels to mta_config
...
| **mta-build** | `6.14.2` | Updated mta_config schema and reference to v1.5.0 (added required fields: application_name, execution_plans_dir, mendix_project_dir). |
| **mta-install-config** | `1.6.2` | Updated mta_config schema and reference to v1.5.0 (added required fields: application_name, execution_plans_dir, mendix_project_dir). |
| **mta-run-analyze** | `6.13.2` | Updated mta_config schema and reference to v1.5.0 (added required fields: application_name, execution_plans_dir, mendix_project_dir). |
| **mta-test-design** | `6.14.2` | Updated mta_config schema and reference to v1.5.0 (added required fields: application_name, execution_plans_dir, mendix_project_dir). |
...
- **Key Changes:** Updated mta_config schema and reference to v1.5.0 (added required fields: application_name, execution_plans_dir, mendix_project_dir).

#### 🔹 mta-install-config (`v1.6.2`)
