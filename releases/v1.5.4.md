...
### 📝 Release Message
Updated state machine to ask for user validation when leaving the QA _Assistance state
...
| **mta-build** | `3.2_1.8` | Updated state machine to ask for user validation when leaving the QA _Assistance state |
| **mta-run-analyze** | `3.2_1.4` | Updated state machine to ask for user validation when leaving the QA _Assistance state |
| **mta-test-design** | `3.2_1.6` | improved behaviour on data varitations for backend tests |
...
#### 🔹 mta-test-design (`v3.2_1.6`)
- **Description:** Scoping and design of test cases for Menditect Test Automation
- **Key Changes:** improved behaviour on data varitations for backend tests
