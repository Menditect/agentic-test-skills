...
### 📝 Release Message
improved skills for first time mta and AI users
...
| **mta-build** | `3.2_2.6` | make data variation descriptions strictly mandatory in reference guides and smoke audits |
| **mta-install-config** | `1.1.2` | updated skills with input from MTA 3.1 reference guide |
| **mta-run-analyze** | `3.2_2.1` | make data variation descriptions strictly mandatory in reference guides and smoke audits |
| **mta-test-design** | `3.2_2.1` | enforce displaying onboarding and starter prompts guide for vague/fresh user request entry triggers |
...
- **Key Changes:** make data variation descriptions strictly mandatory in reference guides and smoke audits
...
#### 🔹 mta-test-design (`v3.2_2.1`)
- **Description:** Scoping and design of test cases for Menditect Test Automation
- **Key Changes:** enforce displaying onboarding and starter prompts guide for vague/fresh user request entry triggers
