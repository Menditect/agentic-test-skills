...
| *Auditing step sequences, validating all 69 testing patterns/anti-patterns (`PAT-01..55`, `ANTI-01..14`), auto-registering new learned patterns* | **`references/mta-patterns-and-antipatterns-reference.md`** |
